  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      {/* Completion meter + unlock CTA — Zeigarnik/goal-gradient pull toward the
          locked sections, in the mobile thumb-zone (Fitts's Law). Only shown to
          non-premium users who still have locked themes. */}
      {(() => {
        ...
        return (
          <>
            {/* spacer so the fixed bar never covers the last content */}
            ...
            <PricingModal isOpen={showUnlockModal} onClose={() => setShowUnlockModal(false)} sectionLabel="Full Self Report" />
          </>
        );
      })()}
    </div >
