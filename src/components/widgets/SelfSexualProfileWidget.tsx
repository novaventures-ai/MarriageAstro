...
export const SelfSexualProfileWidget: React.FC<SelfSexualProfileWidgetProps> = ({
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Navigation Tabs */}
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-2 flex gap-2 transition-colors">
            ...
            {activeTab === 'overview' && (
                <>
                    ...
                    {/* AI Consult Section */}
                    <div className="bg-gradient-to-r from-violet-600 to-indigo-600 rounded-2xl shadow-lg p-6 text-white relative overflow-hidden transition-all">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4 relative z-10">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="px-5 py-2 bg-white text-violet-700 rounded-lg font-bold shadow-lg hover:bg-violet-50 transition-colors disabled:opacity-75 disabled:cursor-not-allowed flex items-center gap-2 text-sm"
                            >
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 transition-colors">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 mb-8">
                            <div className="p-6 bg-rose-50 dark:bg-rose-900/10 rounded-2xl border border-rose-100 dark:border-rose-800/30 transition-colors">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-rose-600 dark:text-rose-400">Your Yoni Type</p>
                        ...
                        <div className="pt-6 border-t border-gray-100 dark:border-gray-700">
                            <div className="flex items-center justify-between mb-4">
                                <h4 className="text-sm font-bold text-gray-500 uppercase tracking-widest">Physiological Traits (Sensitive)</h4>
                                <button
                            ...
                            {showHelp === 'anatomy' && (
                                <div className="mb-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-100 dark:border-blue-800/30 text-xs text-blue-800 dark:text-blue-200 animate-in fade-in slide-in-from-top-2 duration-300">
                                    <div className="grid grid-cols-2 gap-4">
