    ...
    if (!user) {
        return (
            <button
                ...
                id="sign-in-button"
                className="inline-flex items-center gap-2 whitespace-nowrap px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 font-medium text-sm rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-indigo-400 dark:hover:border-indigo-500 shadow-sm hover:shadow transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
                {isSigningIn ? (
