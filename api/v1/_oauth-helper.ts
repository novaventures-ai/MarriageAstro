/**
 * CommonJS-scope copy of api/_oauth-helper.ts for use inside api/v1.
 *
 * api/v1 is CommonJS (see ./package.json) while api/ is ESM — requiring
 * ../_oauth-helper.js from here fails at runtime with ERR_REQUIRE_ESM on
 * Vercel. Keep this file in sync with api/_oauth-helper.ts.
 */
